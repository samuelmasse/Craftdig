...
public partial class AppLog
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool SkipError() => level < LogLevel.Error;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void StartError(string file, int line, out DateTime time, out Utf16ValueStringBuilder sb)
    {
        sb = Open();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EndError(string file, int line, DateTime time, Utf16ValueStringBuilder sb) =>
