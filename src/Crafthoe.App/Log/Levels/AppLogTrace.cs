...
public partial class AppLog
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool SkipTrace() => level < LogLevel.Trace;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void StartTrace(string file, int line, out DateTime time, out Utf16ValueStringBuilder sb)
    {
        sb = Open();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EndTrace(string file, int line, DateTime time, Utf16ValueStringBuilder sb) =>
