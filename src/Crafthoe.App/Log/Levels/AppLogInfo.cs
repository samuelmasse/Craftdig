...
public partial class AppLog
{
        ...
        AppLog? _ = null, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0)
    {
        if (SkipInfo())
            return;
        StartInfo(file, line, out var time, out var sb);
        AppendException(ref sb, exception);
        EndInfo(file, line, time, sb);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T>(string format,
        in T arg,
        Exception? exception = null,
        AppLog? _ = null, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2, T3>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2, T3, T4>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2, T3, T4, T5>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2, T3, T4, T5, T6>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2, T3, T4, T5, T6, T7>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info<T1, T2, T3, T4, T5, T6, T7, T8>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool SkipInfo() => level < LogLevel.Info;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void StartInfo(string file, int line, out DateTime time, out Utf16ValueStringBuilder sb)
    {
        sb = Open();
        LogFormat.StartInfo(file, line, ref sb, out time);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EndInfo(string file, int line, DateTime time, Utf16ValueStringBuilder sb) =>
        End(file, line, time, sb, LogLevel.Info);
}
