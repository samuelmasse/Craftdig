...
public partial class AppLog
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool SkipDebug() => level < LogLevel.Debug;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void StartDebug(string file, int line, out DateTime time, out Utf16ValueStringBuilder sb)
    {
        sb = Open();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EndDebug(string file, int line, DateTime time, Utf16ValueStringBuilder sb) =>
