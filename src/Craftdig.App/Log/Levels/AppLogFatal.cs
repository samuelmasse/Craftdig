...
public partial class AppLog
{
        ...
        AppLog? _ = null, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0)
    {
        if (SkipFatal())
            return;
        StartFatal(file, line, out var time, out var sb);
        AppendException(ref sb, exception);
        EndFatal(file, line, time, sb);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Fatal<T>(string format,
        in T arg,
        Exception? exception = null,
        AppLog? _ = null, [CallerFilePath] string file = "", [CallerLineNumber] int line = 0)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Fatal<T1, T2>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Fatal<T1, T2, T3>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Fatal<T1, T2, T3, T4, T5, T6, T7, T8>(string format,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool SkipFatal() => level < LogLevel.Fatal;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void StartFatal(string file, int line, out DateTime time, out Utf16ValueStringBuilder sb)
    {
        sb = Open();
        LogFormat.StartFatal(file, line, ref sb, out time);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EndFatal(string file, int line, DateTime time, Utf16ValueStringBuilder sb) =>
        End(file, line, time, sb, LogLevel.Fatal);
}
